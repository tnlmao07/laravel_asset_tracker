        ...
        <form action="{{$url}}" method="post" >
          ...
          <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="assettype"  class="form-control" placeholder="Enter Asset Type">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="assetdesc" class="form-control" placeholder="Enter Description">
                  <span class="text-danger">
                    @error('assetdesc')
                        {{$message}}
                    @enderror
