...
<div class="wrapper">
  ...
  <div class="content-wrapper container">
    ...
    <div class="" style="margin-left: 450px;padding-top:20px">
        <a href="asset-type-form">
            <button type="submit" class="btn btn-dark">Add Asset Types</button>
        </a>
    </div>
    <br>
    <div class="container">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{url('/asset-type/delete')}}/{{$a->id}}"><button class="btn btn-danger" onclick="myfunction()">Delete</button></a>
                        <a href="{{route('assettype.edit',['id'=>$a->id])}}"><button class="btn btn-primary">Edit</button></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
