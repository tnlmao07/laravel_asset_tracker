...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    /* Pie chart */
        ...
        var piechart_options = {title:'Active  and inactive assets',
                       width:500,
                       height:350
                       };
    ...
    var data = new google.visualization.DataTable();
        ...
        data.addRows([
         <?php echo $chartDatabar; ?>
        ]);
        var barchart_options = {title:'No of Assets',
                       width:500,
                       height:350,
...
<div id="piechart_div" style="border: 1px solid rgb(255, 0, 0)"></div>

<td><div id="barchart_div" style="border: 1px solid rgb(47, 0, 255)"></div>
