    ...
    <div class="card card-dark m-3">
        ...
        <form action="{{$url}}" method="post" >
          ...
          <div class="card-body">
                ...
                <input type="text" name="assettype" value="{{$assettype->asset_type}}" class="form-control" placeholder="Enter Asset Type">
                ...
                <div class="form-group">
                  <label for="assettype">Description</label>
                  <input type="text" name="assetdesc" value="{{$assettype->asset_description}}" class="form-control" placeholder="Enter Description">
                  <span class="text-danger">
                    @error('assettype')
                        {{$message}}
                    @enderror
